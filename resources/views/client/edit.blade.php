    ...
    <main>
        ...
        <div class="Portada-usuario">
            <div class="panel-cuenta">
                <h2>Mi cuenta</h2>
                <div class="opciones">
                    <a href="{{ route('client') }}" style="width: fit-content;">
                        <div class="celda-opciones">
                            <p>Panel de cuenta</p>
                        </div>
                    </a>
                    <a href="{{ route('client.details') }}" style="width: fit-content;">
                        <div class="celda-opciones">
                            <p>Mis Datos</p>
                        </div>
                    </a>
                    <a href="{{ route('showEditPayment') }}" style="width: fit-content;">
                        <div class="celda-opciones">
                            <p>Metodo de Pago</p>
                        </div>
                    </a>
                    <a href="{{ route('purchase') }}" style="width: fit-content;">
                        <div class="celda-opciones">
